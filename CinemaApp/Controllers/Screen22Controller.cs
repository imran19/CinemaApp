...
{
    public class Screen22Controller : Controller
    {
        ...
        public ActionResult Reservation()
        {
            ...
            List<Screen22> scr = db.Screen22.ToList();
            ...
            try
            {
                var forTime2 = (from t in db.Movies
                                where t.ScreenLinkTime2 == "/Screen22/Reservation"
        ...
        [HttpPost]
        public ActionResult ReserveForScreen22(ReservedSeat obj, Screen22 scr)
        {
        ...
        public ActionResult BillForScreen22()
        {
            if (Session["Role"] == null)
                return RedirectToAction("Login", "Account");
